...
#func _on_mouse_entered() -> void:
	...
	#if background2.modulate.a == 0:
		#background_tween2 = create_tween()
		#background_tween2.tween_property(background2, "modulate:a", 1, 0.5).set_trans(Tween.TRANS_LINEAR)
	...
	#if description_2.modulate.a == 0:
		#description_tween2 = create_tween()
		#description_tween2.tween_property(description_2, "modulate:a", 1.0, 0.5).set_trans(Tween.TRANS_LINEAR)
