...
func pillar_spawn(pillar_position: Vector2):
	...
	if pick_random_timer == 1:
		owner.pillar.timer_set = 14.0
	else:
		owner.pillar.timer_set = 27.0
...
func pillar_spawn_2(pillar_position: Vector2):
	...
	if pick_random_timer == 1:
		owner.pillar_2.timer_set = 14.0
	else:
		owner.pillar_2.timer_set = 27.0
...
func pillar_spawn_3(pillar_position: Vector2):
	...
	if pick_random_timer == 1:
		owner.pillar_3.timer_set = 27.0
	else:
		owner.pillar_3.timer_set = 14.0
	owner.pillar_3.collision_set = false
...
func pillar_spawn_4(pillar_position: Vector2):
	...
	if pick_random_timer == 1:
		owner.pillar_4.timer_set = 27.0
	else:
		owner.pillar_4.timer_set = 14.0
	owner.pillar_4.collision_set = false
