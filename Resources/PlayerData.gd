...
@export var best_time_boss_1 = 0.0
@export var best_time_boss_2 = 0.0
@export var best_time_boss_3 = 0.0
...
@export var clear_count_4 = 0.0
@export var clear_count_5 = 0.0

# First clear stats
@export var first_play_1 = true
@export var first_play_2 = true
...
@export var first_clear_time_3 = 0.0
@export var first_clear_time_4 = 0.0
@export var first_clear_time_5 = 0.0

@export var attempt_count_1 = 0
@export var attempt_count_2 = 0
