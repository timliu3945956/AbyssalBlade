...
@onready var description_5: Label = $"../../../../DescriptionContainer/Description5"
...
func _on_pressed() -> void:
	...
	description_4.visible = false
	description_5.visible = true
	...
	#if background4.modulate.a == 0:
		#background_tween4 = create_tween()
		#background_tween4.tween_property(background4, "modulate:a", 1.0, 0.5).set_trans(Tween.TRANS_LINEAR)
		#
	#if description_1.modulate.a == 1:
		#description_tween1 = create_tween()
		#description_tween1.tween_property(description_1, "modulate:a", 0, 0.5).set_trans(Tween.TRANS_LINEAR)
	...
	#if description_4.modulate.a == 0:
		#description_tween4 = create_tween()
		#description_tween4.tween_property(description_4, "modulate:a", 1.0, 0.5).set_trans(Tween.TRANS_LINEAR)
